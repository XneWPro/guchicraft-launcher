...
$SupportDir = Join-Path $PortableRoot 'Support'
...
Set-Content `
    (Join-Path $SupportDir 'GuchicraftLauncher-debug.bat') `
    -Value $DebugBat `
    -Encoding ASCII
...
1. Start GuchicraftLauncher.exe.
2. If nothing opens, start GuchicraftLauncher-debug.bat and copy the error text.
...
$RequiredPortableFiles = @(
    ...
    'Support\GuchicraftLauncher-debug.bat',
    'version.txt',
