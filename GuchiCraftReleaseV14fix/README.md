...
Документация: `docs/UPDATER_MODULE.md`.

## Сборка Windows-релиза

Запусти `build-release.bat`. Подробная инструкция: [`docs/RELEASE_SYSTEM.md`](docs/RELEASE_SYSTEM.md).

## Portable Release

Run `build-portable.bat` to create a self-contained Windows package before building the final EXE.
See `docs/PORTABLE_RELEASE.md`.
